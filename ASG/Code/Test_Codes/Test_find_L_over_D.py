...
#speeds and records various parameters such as altitude, latitude, and
#longitude values allowing the calculation of L/D ratio
...
#Active X Export----------------------------------------------------------------
execfile('Activex_export_data.py') #Executing ActiveX data export script
